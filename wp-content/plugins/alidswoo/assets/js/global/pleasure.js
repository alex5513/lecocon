jQuery(function($){
	...
	window.Pleasure = {
		...
		settings: {
			...
			paths: {
				images: "/wp-content/plugins/alidswoo/assets/globals/img",
				css: "/wp-content/plugins/alidswoo/assets/globals/css",
				plugins: "/wp-content/plugins/alidswoo/assets/globals/plugins"
			},
		...
		handleTabs: function () {
			...
			var prefix = "tab_";
			var nav = '.nav a[href="'+hash.replace(prefix,"")+'"]';
	
			if (hash && $(nav).length > 0 ) {
				$(nav).trigger('click');
			}
		...
		initSelectPicker: function () {
			...
			$('select.selecter').selectpicker({dropupAuto: false});
		},
